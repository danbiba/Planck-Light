 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  FN  | Ctrl | GUI  | ALT  |Lower |Space |Space |Raise |   /  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,   KC_MINS,   KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE,
    KC_LSFT,KC_BSLS,KC_SLSH,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,  KC_UNDS,   S(KC_NUBS), KC_LBRC, KC_RBRC,XXXXXXX,
    XXXXXXX,KC_CAPSLOCK,XXXXXXX,XXXXXXX, _______, _______, _______, _______,XXXXXXX,KC_LABK,KC_RABK,XXXXXXX
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX, KC_4,     KC_5,   KC_6,   KC_MINS, KC_PLUS,
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX, KC_1,     KC_2,   KC_3,   KC_VOLU, KC_ENT,
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX, _______, _______, _______, _______,  KC_0,   KC_EQL, KC_VOLD, KC_MUTE
),
/* Functio
 * ,-----------------------------------------------------------------------------------.
...
[_FUNCTIO] = LAYOUT_planck_grid(
    ...
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,DM_REC1,DM_PLY1,XXXXXXX,
    LALT(LCTL(KC_DEL)),XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,DM_REC2,DM_PLY2,XXXXXXX,
    _______, LGUI(KC_C),LGUI(KC_V),XXXXXXX, _______, _______, _______, _______,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX
),
...
void rgb_matrix_indicators_kb(void) {
  switch (biton32(layer_state)) {
    case _LOWER:
      ...
      rgb_matrix_set_color(1, 0, 190, 255);
      rgb_matrix_set_color(2, 0, 190, 255);
      rgb_matrix_set_color(3, 0, 190, 255);
      rgb_matrix_set_color(4, 0, 190, 255);
      rgb_matrix_set_color(5, 0, 190, 255);
      rgb_matrix_set_color(6, 0, 190, 255);
      rgb_matrix_set_color(7, 190, 0, 255);
      rgb_matrix_set_color(8, 190, 0, 255);
      rgb_matrix_set_color(9, 190, 0, 255);
      rgb_matrix_set_color(10, 0, 190, 255);
      ...
      rgb_matrix_set_color(48, 234, 250, 6);
       break;
    case _COLEMAK:
      rgb_matrix_set_color(0, 255, 0, 0);
      rgb_matrix_set_color(1, 0, 190, 255);
    ...
    case _RAISE:
      ...
      rgb_matrix_set_color(23, 255, 0, 255);
      ...
      rgb_matrix_set_color(47, 255, 0, 255);
    ...
    case _ADJUST:
      ...
      break;
      case _FUNCTIO:
      rgb_matrix_set_color(0, 244, 130, 0);
      rgb_matrix_set_color(1, 244, 130, 0);
      rgb_matrix_set_color(2, 244, 130, 0);
      rgb_matrix_set_color(3, 244, 130, 0);
      rgb_matrix_set_color(4, 244, 0, 130);
      rgb_matrix_set_color(5, 244, 0, 130);
      rgb_matrix_set_color(6, 244, 0, 130);
      rgb_matrix_set_color(7, 244, 0, 130);
      rgb_matrix_set_color(8, 0, 130, 244);
      rgb_matrix_set_color(9, 0, 130, 244);
      rgb_matrix_set_color(10, 0, 130, 244);
      rgb_matrix_set_color(11, 0, 130, 244);
      rgb_matrix_set_color(12, 0, 0, 0);
      rgb_matrix_set_color(13, 0, 0, 0);
      rgb_matrix_set_color(14, 0, 0, 0);
      rgb_matrix_set_color(15, 0, 0, 0);
      ...
      rgb_matrix_set_color(21, 255, 0, 120);
      rgb_matrix_set_color(22, 255, 0, 0);
      ...
      rgb_matrix_set_color(33, 3, 102, 252);
    ...
    default:
      switch (biton32(default_layer_state)) {
        case _QWERTY:
          rgb_matrix_layer_helper(0x00, 0x68, 0x68); break;
        //case _COLEMAK:
